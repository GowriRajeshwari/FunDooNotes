...
import {archiveNoteList,getNotesListByLabel, getNotes,setNotes,
deleteNotes,removeRemainderNotes,updateReminderNotes,changeColor,archiveNote,deletelabelNotes } from '../services/notesService'
...
import { Divider,Typography,Card,CardContent,Grid,List} from "@material-ui/core";
...
class Archived extends Component {
  ...
  UNSAFE_componentWillReceiveProps=(nextProps)=>{
    if(nextProps.labelNoteShow){
     this.setState({ labelNoteShow : nextProps.labelNoteShow ,label :nextProps.label})
    }
 ...
 if (response.status === 200) {
  ...
  render() {
    ...
    style={{borderRadius:'20px',cursor:'pointer',padding:'20px'}} >  
      <Card  className={this.props.gridView ? "mydivoutergrid" : "mydivouter" } style={{backgroundColor :  data.color
